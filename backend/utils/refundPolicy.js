...
function calculateRefundPolicy({ totalAmount = 0, tripDate, bookingDate, cancelDate = new Date() } = {}) {
  ...
  const cancellationCharges = amount - refundAmount;
...
function calculateRefundPolicyFromBooking(booking, options = {}) {
